            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('vendor.dashobard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($vendorData->photo) ? url('upload/vendor_images/' . $vendorData->photo) : url('upload/no_image.jpg') }}"
                                        alt="vendor image" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="name" class="form-control"
                                                value="{{ $vendorData->name }}" placeholder="Full Name" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="email" name="email" class="form-control"
                                                value="{{ $vendorData->email }}" placeholder="Email" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="phone" class="form-control"
                                                value="{{ $vendorData->phone }}" placeholder="Phone"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="address" class="form-control"
                                                value="{{ $vendorData->address }}" placeholder="Address"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img class="img-thumbnail" id="showImage"
                                                ...
                                                alt="vendor image" style="width:100px; height: 100px;">
                                        </div>
                                    </div>
