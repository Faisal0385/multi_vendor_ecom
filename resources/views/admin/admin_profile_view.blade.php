            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashobard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="name" class="form-control"
                                                value="{{ $adminData->name }}" placeholder="Full Name" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="email" name="email" class="form-control"
                                                value="{{ $adminData->email }}" placeholder="Email" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="phone" class="form-control"
                                                value="{{ $adminData->phone }}" placeholder="Phone"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="address" class="form-control"
                                                value="{{ $adminData->address }}" placeholder="Address"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3 d-flex justify-content-start align-items-center">
